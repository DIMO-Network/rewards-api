...
func (o *Reward) GetIssuanceWeek() *IssuanceWeek {
	if o == nil {
		return nil
	}
...
func (o *Reward) GetTransferMetaTransactionRequest() *MetaTransactionRequest {
	if o == nil {
		return nil
	}

	return o.R.GetTransferMetaTransactionRequest()
}
