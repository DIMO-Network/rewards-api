...
type Referral struct {
	...
	RefereeUserID         string      `boil:"referee_user_id" json:"referee_user_id" toml:"referee_user_id" yaml:"referee_user_id"`
...
var ReferralTableColumns = struct {
	...
	RefereeUserID:         "referrals.referee_user_id",
}
...
var ReferralWhere = struct {
	...
	RefereeUserID         whereHelperstring
}{
	...
	RefereeUserID:         whereHelperstring{field: "\"rewards_api\".\"referrals\".\"referee_user_id\""},
}
...
func (o *Referral) GetIssuanceWeek() *IssuanceWeek {
	if o == nil {
		return nil
	}
...
func (o *Referral) GetRequest() *MetaTransactionRequest {
	if o == nil {
		return nil
	}
...
var (
	referralAllColumns            = []string{"referee", "referrer", "transfer_successful", "transfer_failure_reason", "request_id", "issuance_week_id", "referrer_user_id", "referee_user_id"}
	referralColumnsWithoutDefault = []string{"referee", "referrer", "request_id", "issuance_week_id", "referee_user_id"}
...
func (o *Referral) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(referralAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(referralPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert referrals, could not build conflict column list")
			}

			conflict = make([]string, len(referralPrimaryKeyColumns))
			copy(conflict, referralPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"rewards_api\".\"referrals\"", updateOnConflict, ret, update, conflict, insert, opts...)
