...
type Referral struct {
	...
	ReferreeUserID        null.String `boil:"referree_user_id" json:"referree_user_id,omitempty" toml:"referree_user_id" yaml:"referree_user_id,omitempty"`
...
var ReferralColumns = struct {
	...
	ReferreeUserID:        "referree_user_id",
}
...
var ReferralTableColumns = struct {
	...
	ReferreeUserID:        "referrals.referree_user_id",
}
...
var ReferralWhere = struct {
	...
	ReferreeUserID        whereHelpernull_String
}{
	...
	ReferreeUserID:        whereHelpernull_String{field: "\"rewards_api\".\"referrals\".\"referree_user_id\""},
}
...
var (
	...
	referralColumnsWithDefault    = []string{"transfer_successful", "transfer_failure_reason", "referrer_user_id", "referree_user_id"}
