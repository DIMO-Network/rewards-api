// Package docs Code generated by swaggo/swag at 2024-12-18 10:51:48.615429 -0500 EST m=+1.456642418. DO NOT EDIT
package docs
        ...
        "/rewards/convert": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Time in the week to calculate potential tokens earned based on the provided points (defaults to last week) (format 2006-01-02T15:04:05Z07:00)",
                        "name": "time",
                        "in": "query"
                    }
                ],
