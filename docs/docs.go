...
// 2023-03-28 08:57:33.324935 -0600 MDT m=+33.571830960
package docs
...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github.com_DIMO-Network_rewards-api_internal_controllers.ReferralHistory"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "github.com_DIMO-Network_rewards-api_internal_controllers.ReferralHistory": {
            "type": "object",
            "properties": {
                "completed": {
                    "description": "CompletedReferrals referrals for which awards have already been sent",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github.com_DIMO-Network_rewards-api_internal_controllers.referral"
                    }
                },
                "referredBy": {
                    "description": "ReferredBy address of user that that account was referred by",
                    "$ref": "#/definitions/github.com_DIMO-Network_rewards-api_internal_controllers.referral"
                }
            }
        },
        ...
        "github.com_DIMO-Network_rewards-api_internal_controllers.referral": {
            "type": "object",
            "properties": {
                "issued": {
                    "type": "string"
        ...
        "internal_controllers.ReferralHistory": {
            "type": "object",
            "properties": {
                "completed": {
                    "description": "CompletedReferrals referrals for which awards have already been sent",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_controllers.referral"
                    }
                },
                "referredBy": {
                    "description": "ReferredBy address of user that that account was referred by",
